          ...
          {state.archiveSlots.map((slot, index) => (
            <div key={index} className={`flex flex-col gap-4 ${slot ? '' : 'opacity-40'}`}>
              <div className="flex items-center justify-between">
                <div className="kol-helper-14 text-fg-32">
                ...
                {slot ? (
                  <button
                    className="kol-helper-12 text-fg-32 hover:text-fg-64 transition-colors cursor-pointer"
                    onClick={() => state.clearArchiveSlot(index)}
                  >
                    [CLEAR]
                  </button>
                ) : (
                  <div className="kol-helper-12 text-fg-32">[EMPTY]</div>
                )}
              </div>
              ...
              >
                {slot ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="kol-helper-14 text-fg-32">No saved experiment</div>
                  </div>
                )}
              </div>
              ...
              {slot ? (
                <div className="flex items-center justify-end gap-2">
                  <button
                    className="kol-helper-12 text-fg-48 hover:text-fg-96 transition-colors cursor-pointer"
                ...
                <div className="kol-helper-12 text-fg-32 text-right">&mdash;</div>
              )}
            </div>
          ))}
        </div>
