...
const KALEIDOSCOPE_CONTROLS = [
  { key: 'animate', type: 'toggle', label: 'Animate', default: false },
  { key: 'segments', type: 'slider', label: 'Segments', min: 2, max: 24, step: 1, default: 6 },
  { key: 'zoom', type: 'slider', label: 'Zoom', min: 0.5, max: 5.0, step: 0.1, default: 1.5 },
  { key: 'sourceOffsetX', type: 'slider', label: 'Source X', min: -200, max: 200, step: 1, default: 0 },
  { key: 'sourceOffsetY', type: 'slider', label: 'Source Y', min: -200, max: 200, step: 1, default: 0 },
  { key: 'cutOffset', type: 'slider', label: 'Cut Offset', min: 0, max: 360, step: 1, default: 0 },
  { key: 'segmentGap', type: 'slider', label: 'Segment Gap', min: -20, max: 20, step: 0.5, default: 0 },
  { key: 'evenOffset', type: 'slider', label: 'Even Offset', min: -30, max: 30, step: 1, default: 0 },
  { key: 'speed', type: 'slider', label: 'Speed', min: 0.1, max: 5.0, step: 0.1, default: 0.5 },
  { type: 'divider' },
  { key: 'mirrorMode', type: 'binary', label: 'Mirror', options: [{ value: 'alternating', label: 'Alternating' }, { value: 'all-same', label: 'All Same' }], default: 'alternating' },
  { key: 'rotationDirection', type: 'binary', label: 'Rotation', options: [{ value: 'clockwise', label: 'CW' }, { value: 'counterclockwise', label: 'CCW' }], default: 'clockwise' },
  { key: 'splitRotation', type: 'toggle', label: 'Split Rotation', default: false },
  { type: 'divider' },
  { key: 'maskShape', type: 'select', label: 'Shape', options: [
    { value: 'circle', label: 'Circle' },
    { value: 'square', label: 'Square' },
    { value: 'diamond', label: 'Diamond' },
    { value: 'none', label: 'None' },
  ], default: 'circle' },
  { key: 'maskArea', type: 'slider', label: 'Mask Area', min: 0, max: 200, step: 1, default: 0 },
  { key: 'maskMode', type: 'binary', label: 'Mask Mode', options: [{ value: 'bipolar', label: 'Bipolar' }, { value: 'inside', label: 'Inside' }], default: 'bipolar' },
  { key: 'feather', type: 'slider', label: 'Feather', min: 0, max: 50, step: 1, default: 0 },
